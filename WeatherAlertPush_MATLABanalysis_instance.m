...
% webhooks of IFTTT的 （如欲推送只Telegram，请取消下一行的注释）
...
% 目标城市识别与预警信息推送
clear n datav datat
n=find(strcmp('襄阳市',city)==1); %目标城市预警信息条目识别
if length(n)>0
        % 读取Thingspeak Channel field 1 三天内的记录，datav是field
        % 1的数值，datat是该数值的timestamp。
        try
